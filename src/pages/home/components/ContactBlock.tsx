...
const ContactBlock: React.FC<ContactBlockProps> = () => {
  const react3dEarthStyle = {
    width: "100vw",
    height: "100vh",
    position: "absolute",
    zIndex: "0",
  };
  const react3dEarthConfig = {
    radius: 15,
    mobileRadius: 10,
    flagScale: 3,
    flagLat: 41.0036,
    ...
    <div className="h-screen w-screen relative top-1200vh z-2 cursor-auto">
      <div className="absolute z-1 w-full text-white p-5vw flex">
        <div className="text-1.5vw block mr-auto">
          <p className="text-2vw mb-10vw">Right now I live in Istanbul and ready to work remotely.</p>
        ...
        <div className="flex flex-col text-1.5vw">
          ...
          <div className="w-fit grid grid-cols-2 gap-2vw">
            ...
            <a className="text-blue-500 !cursor-pointer" href="https://t.me/Vladislav_ILTS" target="_blank">
              @Vladislav_ILTS
            </a>
            <span className="mr-2vw">Whats App link:</span>
            <a className="text-blue-500 !cursor-pointer" href="https://wa.me/+905360512154" target="_blank">
              +90 536 051 21 54
            </a>
            <span className="mr-2vw">Linked In:</span>
            <a className="text-blue-500 !cursor-pointer" href="https://www.linkedin.com/in/vladislav-gorbach-251442261" target="_blank">
              Vladislav Gorbach
            </a>
          </div>
        </div>
      </div>
      <React3dEarth style={react3dEarthStyle} config={react3dEarthConfig} />
    </div>
  );
};
