...
export const Logo: React.FC<IconProps> = memo(props => {
  const { className, ...otherProps } = props

  return (
    <svg className={cls(className)} viewBox="0 0 172 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...otherProps}>
      <rect width="172" height="32" fill="url(#logo-icon-pattern)" />
      <defs>
        <pattern id="logo-icon-pattern" patternContentUnits="objectBoundingBox" width="1" height="1">
          <use xlinkHref="#logo-icon" transform="translate(0 -0.00166667) scale(0.00333333 0.0179167)" />
        </pattern>
        <image
          id="logo-icon"
          width="300"
