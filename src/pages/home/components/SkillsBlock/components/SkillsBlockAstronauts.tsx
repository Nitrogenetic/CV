interface SkillsBlockAstronautsProps {
  type?: "languages" | "query-languages" | "frameworks" | "compiler" | "builders" | "other";
}
    ...
    case "languages":
      return (
        <div className="fixed top-100vh left-30vw transform duration-700">
          ...
          <img src={"images/astronaut1.png"} className="w-20vw h-auto absolute top-25vw right-25vw z-1" />
        </div>
      );
    case "query-languages":
      return (
        <div className="fixed top-30vh left-100vw transform duration-700">
          ...
          <img src={"images/astronaut2.png"} className="bg-red-00 w-20vw h-auto absolute top-4vw left-29.2vw z-1" />
        </div>
      );
    case "frameworks":
      return (
        <div className="fixed top-15vh right-100vw transform duration-700">
          ...
          <img src={"images/astronaut4.png"} className="bg-red-00 w-20vw h-auto absolute top-12vw right-21.5vw z-0" />
        </div>
      );
    case "compiler":
      return (
        <div className="fixed top-100vh right-35vw transform duration-700">
          ...
          <img src={"images/astronaut3.png"} className="bg-red-00 w-20vw h-auto absolute top-1.5vw left-7vw z-1" />
        </div>
      );
    case "builders":
      return (
        <div className="fixed top-60vh right-100vw transform duration-700">
          ...
          <img src={"images/astronaut5.png"} className="bg-red-00 w-20vw h-auto absolute top-0vw right-25.5vw z-1" />
        </div>
      );
  }
