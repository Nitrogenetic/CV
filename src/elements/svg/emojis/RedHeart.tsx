...
export const RedHeart: React.FC<IconProps> = memo(props => {
  ...
  return (
    <svg
      ...
      {...otherProps}
    >
      <path d="M0 18.26H18V0.26H0V18.26Z" fill="url(#redHeartPattern)" />
      <defs>
        <pattern id="redHeartPattern" patternContentUnits="objectBoundingBox" width="1" height="1">
          <use xlinkHref="#image0_8712_129817" transform="scale(0.015625)" />
        </pattern>
        <image
          id="image0_8712_129817"
          width="64"
          height="64"
